...
| Admin module for Power BI Cmdlets | [MicrosoftPowerBIMgmt.Admin](../powerbi-ps/MicrosoftPowerBIMgmt.Admin/MicrosoftPowerBIMgmt.Admin.md) | [![MicrosoftPowerBIMgmt.Admin](https://img.shields.io/powershellgallery/v/MicrosoftPowerBIMgmt.Profile.svg?style=flat-square&label=MicrosoftPowerBIMgmt.Admin)](https://www.powershellgallery.com/packages/MicrosoftPowerBIMgmt.Admin/) |
| Capacities module for Power BI Cmdlets | [MicrosoftPowerBIMgmt.Capacities](../powerbi-ps/MicrosoftPowerBIMgmt.Capacities/MicrosoftPowerBIMgmt.Capacities.md) | [![MicrosoftPowerBIMgmt.Capacities](https://img.shields.io/powershellgallery/v/MicrosoftPowerBIMgmt.Profile.svg?style=flat-square&label=MicrosoftPowerBIMgmt.Capacities)](https://www.powershellgallery.com/packages/MicrosoftPowerBIMgmt.Capacities/) |
